...
function SiteBlog() {
  return   <div className="SiteBlog.banner-container-160">
  <div className="banner-content">
    <div className="blocks">
      <section className="block-13">
        <div className="app-text distance-9">Blog</div>
        <div className="all-features">All Articles<img className="vector3" src={Vector3Image} /></div>
      </section>
      <section className="images-2">
        <div>
          <img className="distance-11" src={ImageImage} />
          <div className="title-5">How To Start Using Banko For Your Startup</div>
          <div className="text-features distance-12">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Dui accumsan sit amet nulla facilisi morbi.
          </div>
        ...
        <div>
          ...
          <div className="title-5">10 Things Nobody Told You About Banko</div>
          <div className="text-features distance-12">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et
            dolore magna aliqua. Dui accumsan sit amet nulla facilisi morbi.
          </div>
