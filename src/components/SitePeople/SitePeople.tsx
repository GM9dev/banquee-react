...
function SitePeople() {
  return   <div className="SitePeople.banner-container-160">
  <div className="banner-content banner-size">
    <div className="block-8">
      <section className="margin">
        <div className="info">Testimonials</div>
        <div className="title-1 break-line distance-4">People all over the world use banko.</div>
      </section>
    ...
    <div className="block-9">
      <div className="size size-1">
        ...
        <div className="title-5">Sunt qui esse pariatur duis deserunt mollit</div>
      ...
      <div className="size size-2">
        ...
        <div className="distance-6 padding-2">
          <div className="text-features">
            ...
            <br />
            <br />
            In nibh mauris cursus mattis. At lectus urna duis convallis convallis tellus. Enim blandit volutpat
            maecenas volutpat.
          </div>
        </div>
      ...
      <div className="size size-3">
        <img className="rating" src={RatingImage} />
        <div className="title-5">Elit aute irure tempor cupidatat incididunt</div>
        <div className="distance-6">
          <div className="text-features">
      ...
      <div className="size size-5">
        ...
        <div className="distance-6">
          <div className="text-features">
            Etiam accumsan porta neque in viverra. Proin eleifend, eros in tristique hendrerit, nisi purus cursus
            sapien, id ultrices nunc tellus a ipsum. Donec et fringilla neque. Aenean consequat purus quis lectus
            maximus fermentum.
          </div>
        </div>
