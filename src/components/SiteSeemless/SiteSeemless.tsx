...
function SiteSeemless() {
  return   <div className="SiteSeemless.banner-container-160">
      ...
      <div className="second-block-4">
        <div className="list-2">
          <div className="list-margin-2">
            <img className="badge-4" src={BadgeImage} />Secure and encrypted integration
          </div>
          <div className="list-margin-2">
            <img className="badge-4" src={BadgeImage} />Fully API interface
          </div>
          <div className="list-margin-2">
            <img className="badge-4" src={BadgeImage} />Payments worldwide
          </div>
        </div>
      </div>
    </section>
