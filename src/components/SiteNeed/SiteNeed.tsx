...
function SiteNeed() {
  return   <div className="SiteNeed.banner-container-160">
  <div className="banner-content">
    <div className="block-11">
      ...
      <section className="block-12">
        ...
        <div className="distance-8 padding-3 border-bottom">
          <div className="info info-2">How to change my account limits?</div>
          <img className="add-img" src={RiAddImage} />
        </div>
        ...
        <div className="text-6 border-bottom text-features">
          ...
          dolore magna aliqua. Dui accumsan sit amet nulla facilisi morbi. Eget gravida cum sociis natoque penatibus
          et
