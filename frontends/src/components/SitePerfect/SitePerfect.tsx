    ...
    <div className="SitePerfect banner-container-160">
      <div className="banner-content">
        <div className="block-7">
          ...
          <div className="title-2">{templateData.mainTitle}</div>
          <div className="title-2 bottom">{templateData.mainTitle2}</div>
          <p className="text-2">
          ...
          <div className="buttons">
            ...
            <div className="compare-cards-2">{templateData.secondButtonText}</div>
          </div>
        </div>
      </div>
    </div>
